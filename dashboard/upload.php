                                    ...
                                    <form action="config/uploadfile.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-lg-12 col-sm-12 col-md-12 col-12">
                                                <a type="button" data-bs-toggle="modal" data-bs-target="#upload" class="btn btn-success w-100">Upload</a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        Are you sure all the details you entered here are correct?.
                                                    </div>
