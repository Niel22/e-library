        ...
        <div class="pagetitle">
          ...
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">PDFs & Notes</li>
            </ol>
          </nav>
        </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card  ">
                ...
                <div class="card-body ">
                  <p class="card-title">This section is showcasing the available PDFs & Notes for all Departments</p>
                  <div class="table-responsive">
                    <?php
                    $sql = "SELECT * FROM materials WHERE type = 'PDFs/Notes' ORDER BY id DESC";
                    ...
                    $sql = "SELECT * FROM materials WHERE type = 'PDFs/Notes' LIMIT $start, $rowLimit";
                    $result = $conn->query($sql);
                    ?>
                    <table class="table">
                      <thead>
