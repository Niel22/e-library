...
?>
    ...
    <body>
      ...
      <main id="main" class="main">
              ...
              <div class="card  ">
                ...
                <div class="card-body ">
                  ...
                  <div class="table-responsive">
                    ...
                    $sql = "SELECT * FROM admin LIMIT $start, $rowLimit";
                    $result = $conn->query($sql);
                    ?>
                    <table class="table">
                      <thead>
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                              ...
                              <td>
                                <a href="config/deleteadmin.php?id=<?= $rows['admin_id']; ?>" class="btn btn-danger">
                        ...
                        <?php
                          ...
                          echo '<tr><td colspan="7">No Admins available</td></tr>';
                        }
                        ?>
                      </tbody>
                    </table>
        ...
        <a href="admin-request.php" class="btn btn-success">Admin Request</a>
            </div><!-- End Top Selling -->
