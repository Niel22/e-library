          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="card  ">
                ...
                <div class="card-body ">
                  <p class="card-title">This section is showcasing the available Textbooks for all Departments</p>
                  <div class="table-responsive">
                    <?php
                    $sql = "SELECT * FROM materials WHERE type = 'Textbooks' ORDER BY id DESC";
                    ...
                    $sql = "SELECT * FROM materials WHERE type = 'Textbooks' LIMIT $start, $rowLimit";
                    $result = $conn->query($sql);
                    ?>
                    <table class="table">
                      <thead>
                      ...
                      <tbody>
                        ...
                        <?php
                          ...
                          echo '<tr><td colspan="7">No Textbooks available</td></tr>';
                        }
                        ?>
                      </tbody>
                    </table>
